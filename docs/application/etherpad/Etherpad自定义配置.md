 ...
 */
{
  ...
  "automaticReconnectionTimeout": 3,
  /*
  ...
  "importMaxFileSize": "${IMPORT_MAX_FILE_SIZE:104857600}", // 100 * 1024 * 1024
  /*
  ...
  "toolbar": {
    ...
    "timeslider": [["timeslider_export", "timeslider_returnToPad"]]
  },
  /*
  ...
  "ep_image_upload": {
    "storage": {
      "type": "local",
      "baseFolder": "./src/static/upload_image",
      "baseURL": "http://localhost:3001/static/upload_image/"
    },
